...
It can be helpful to do expansion of the macros to see how the expansions expand.  This can be done with
`cargo expand --bin macros`

It can be helpful to use the cargo expand crate.  Install by running `cargo install cargo-expand`.  Using this requires
having access to some experimental features in the Rust nightly build.  To enable the nightly toolchain:
